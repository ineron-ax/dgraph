...
func (rewriter *entitiesQueryRewriter) Rewrite(context context.Context, query schema.Query) ([]*gql.GraphQuery, error) {
...
func (rewriter *entitiesQueryRewriter) rewriteImpl(gqlQuery schema.Query, authRw *authRewriter) ([]*gql.GraphQuery, error) {
